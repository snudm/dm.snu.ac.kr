...
var n = noty({
    ...
    text: '<strong>[빅데이터 AI 연구실 소식]</strong><br><br>- 조성준 교수는 2021년 11월 26일 대한상공회의소에서 열린 2021 한국경영과학회 (회장: 한양대 한형상 교수) 추계학술대회에서 경영과학을 이용하여 조직의 발전과 경쟁력을 향상시킨 공로로 “조해형 한국경영과학산학협력 대상” 을 수상했다.<br><br><a onclick="close_popup()">[팝업 닫기]</a>',
    animation: {
        open: 'animated bounceInDown',
        close: {height: 'toggle'}, // jQuery animate function property object
        easing: 'swing', // easing
