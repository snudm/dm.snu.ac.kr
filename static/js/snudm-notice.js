...
var n = noty({
    layout: 'topRight',
    theme: 'relax',
    text: '<strong>[2023 SNU Venture Builder 최우수상 수상]</strong><br><br>- 대회명 : SNU Venture Builder 시즌2 대학원생 데모데이<br>- 주관 : 중소벤처기업부, 창업진흥원, 서울대학교<br>- 수상 내용 : 채성원 연구원(공동소속 GenIP), 최우수상 수상<br><a href="https://event-us.kr/neuralworks/event/65309" class="pull-left">[바로가기]</a><br>',
    animation: {
        open: 'animated bounceInDown',
        close: {height: 'toggle'}, // jQuery animate function property object
        easing: 'swing', // easing
